document.addEventListener('DOMContentLoaded', () => {
    ...
    const summariesDb = {
        ...
        'toxic_people': {
            title: '독성인간',
            subtitle: '리앤 텐 브링크 저 | 웅진지식하우스 | 강연: 이동우',
            content: `
                <h4>1. 매혹적으로 다가와 조직을 휘두르는 다크 심리의 실체</h4>
                <p>사이코패스, 나르시시스트, 마키아벨리언 등 비즈니스 현장과 조직 내부에서 성과를 갉아먹고 구성원을 가스라이팅하는 '독성 인간(Poisonous People)'들의 뇌 과학적·심리학적 행동 패턴을 파헤칩니다.</p>
                
                <h4>2. 독성인간 간파법과 7가지 무력화 심리 전략</h4>
                <p>10초 만에 상대의 위험 요소를 간파하는 직관 훈련부터, 리더로서 조직 내부의 독성 요소를 선제 격리하고 건강한 조직 문화와 심적 안전감을 지켜내는 7가지 정밀 대응 프레임워크를 전수합니다.</p>
            `
        },
        'endure_mind': {
